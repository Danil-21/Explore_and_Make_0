# Generated by Django 4.2.30 on 2026-04-25 18:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('status', models.CharField(choices=[('Сделать', 'сделать'), ('В процессе', 'в процессе'), ('Готово', 'готово')], default='Сделать', max_length=50)),
                ...
                ('performer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='performed_tasks', to=settings.AUTH_USER_MODEL)),
